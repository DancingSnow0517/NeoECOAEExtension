...
public final class NEFrequencyAllocator {
    ...
    /**
     * Reuses an existing frequency with room for another host. Once all known
     * frequencies are full, the next unused frequency is created. The least
     * populated frequency is only used after the bounded range is exhausted.
     */
