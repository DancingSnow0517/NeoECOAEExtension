...
public abstract class AbstractECOFluidHatchBlock<T extends NEBlockEntity<?, T>> extends NEBlock<T> {
    protected AbstractECOFluidHatchBlock(Properties properties) {
        super(properties);
    }
