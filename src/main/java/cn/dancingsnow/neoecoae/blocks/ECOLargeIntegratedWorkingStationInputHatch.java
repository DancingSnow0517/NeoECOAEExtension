...
public class ECOLargeIntegratedWorkingStationInputHatch
    extends NEBlock<ECOLargeIntegratedWorkingStationInputHatchBlockEntity> implements BlockUIMenuType.BlockUI {
    ...
    public ModularUI createUI(BlockUIMenuType.BlockUIHolder holder) {
        if (holder.player.level().getBlockEntity(holder.pos)
            instanceof ECOLargeIntegratedWorkingStationInputHatchBlockEntity blockEntity) {
