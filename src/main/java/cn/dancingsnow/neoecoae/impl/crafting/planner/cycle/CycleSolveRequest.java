...
/** Minimal stable boundary for the future cycle implementation. Amounts are request state, not graph state. */
public record CycleSolveRequest(
    ...
    public record PlannerOptions(boolean cyclePlanningEnabled) {}
