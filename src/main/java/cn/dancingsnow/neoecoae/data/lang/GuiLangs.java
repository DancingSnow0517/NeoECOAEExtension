...
public class GuiLangs {
    public static void accept(RegistrateLangProvider provider) {
        ...
        provider.add("gui.neoecoae.crafting_report.total_consumed", "Consumed: %s");
        provider.add("gui.neoecoae.crafting_report.total_produced", "Produced: %s");
        ...
        provider.add(
                ...
                "A cyclic recipe was detected. Cycle planning is not supported yet.");
        provider.add("gui.neoecoae.crafting_graph.open", "Planning Graph");
        provider.add("gui.neoecoae.crafting_graph.title", "ECO Crafting Plan");
        ...
        provider.add("gui.neoecoae.crafting_graph.toolbar.root", "Root node");
        ...
        provider.add("gui.neoecoae.crafting_graph.details.cluster_hint", "Double-click a cycle node to inspect it");
        ...
        provider.add("gui.neoecoae.crafting_graph.summary.more_suffix", " items");
        provider.add("gui.neoecoae.crafting_graph.details.folder", "Folder");
        ...
        provider.add("gui.neoecoae.crafting_graph.details.inventory", "Inventory: %s");
        provider.add("gui.neoecoae.crafting_graph.details.to_craft", "To craft: %s");
        provider.add("gui.neoecoae.crafting_graph.details.consumed", "Task consumed: %s");
        provider.add("gui.neoecoae.crafting_graph.details.produced", "Task produced: %s");
