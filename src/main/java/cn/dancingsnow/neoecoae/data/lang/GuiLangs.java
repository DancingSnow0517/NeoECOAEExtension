...
public class GuiLangs {
        public static void accept(RegistrateLangProvider provider) {
                ...
                provider.add("gui.neoecoae.storage.status.domain_missing_restore_parts", "Restore requires %d/%d original matrices and %d/%d infinite components");
                ...
                provider.add("gui.neoecoae.host.computation.batch_fair_scheduling", "Enable ECO Round-Robin Scheduling");
                provider.add("gui.neoecoae.host.computation.batch_fair_scheduling.enabled", "Enabled");
                provider.add("gui.neoecoae.host.computation.batch_fair_scheduling.disabled", "Disabled");
                ...
                provider.add("gui.neoecoae.crafting.overclock_status",
                                "Theoretical Overclock: %d, Effective Overclock: %d");
                ...
                provider.add("gui.neoecoae.host.crafting.overclock_summary",
                                "Theoretical %d, effective %d, coolant max %s.");
