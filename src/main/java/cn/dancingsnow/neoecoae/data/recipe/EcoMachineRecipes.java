...
public class EcoMachineRecipes {
    public static void init(RegistrateRecipeProvider provider) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_THREADING_CORE_L6)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_computation_thread_core_l4",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_THREADING_CORE_L4))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_THREADING_CORE_L9)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_computation_thread_core_l6",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_THREADING_CORE_L6))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_PARALLEL_CORE_L6)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_computation_parallel_core_l4",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_PARALLEL_CORE_L4))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_PARALLEL_CORE_L9)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_computation_parallel_core_l6",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_PARALLEL_CORE_L6))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_COOLING_CONTROLLER_L6)
                ...
                .unlockedBy(
                        "has_computation_cooling_controller_l4",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_COOLING_CONTROLLER_L4))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.COMPUTATION_COOLING_CONTROLLER_L9)
                ...
                .define('D', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_computation_cooling_controller_l6",
                        RegistrateRecipeProvider.has(NEBlocks.COMPUTATION_COOLING_CONTROLLER_L6))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.CRAFTING_PARALLEL_CORE_L6)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_crafting_parallel_core_l4",
                        RegistrateRecipeProvider.has(NEBlocks.CRAFTING_PARALLEL_CORE_L4))
                .save(provider);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, NEBlocks.CRAFTING_PARALLEL_CORE_L9)
                ...
                .define('B', NEItems.SUPERCONDUCTING_PROCESSOR)
                .unlockedBy(
                        "has_crafting_parallel_core_l6",
                        RegistrateRecipeProvider.has(NEBlocks.CRAFTING_PARALLEL_CORE_L6))
                .save(provider);
