...
public class NEPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> ORE_ALUMINUM = key("ore_aluminum"),
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(
                ...
                commonOrePlacement(
                        60, HeightRangePlacement.triangle(VerticalAnchor.absolute(60), VerticalAnchor.absolute(256))));
        PlacementUtils.register(
                context,
                ORE_ALUMINUM_SMALL,
                lookup.getOrThrow(NEConfiguredFeatures.ORE_ALUMINUM_SMALL),
                commonOrePlacement(
                        10, HeightRangePlacement.triangle(VerticalAnchor.absolute(10), VerticalAnchor.absolute(70))));
        PlacementUtils.register(
                context,
                ORE_TUNGSTEN,
