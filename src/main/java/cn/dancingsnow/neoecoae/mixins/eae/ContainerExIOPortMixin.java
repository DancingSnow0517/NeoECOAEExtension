...
public class ContainerExIOPortMixin {
    @WrapOperation(method = "setupConfig", at = @At(
        value = "INVOKE",
        target = "Lcom/glodblock/github/extendedae/container/ContainerExIOPort;addSlot(Lnet/minecraft/world/inventory/Slot;Lappeng/menu/SlotSemantic;)Lnet/minecraft/world/inventory/Slot;",
        ordinal = 0)
    )
