...
public class NEItems {
        ...
        public static final ItemEntry<AxeItem> TUNGSTEN_AXE = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ctx.get())
                                                ...
                                                .define('B', Items.STICK)
                                                .unlockedBy("has_tungsten_ingot",
                                                                RegistrateRecipeProvider
                                                                                .has(NETags.Items.TUNGSTEN_INGOT))
                                                .save(prov);
                        })
                        .register();
        ...
        public static final ItemEntry<SmithingTemplateItem> ALUMINUM_ALLOY_UPGRADE_SMITHING_TEMPLATE = REGISTRATE
                        .<SmithingTemplateItem>item("aluminum_alloy_upgrade_smithing_template",
                                        p -> new NamedSmithingTemplateItem(
                                                        "item.neoecoae.aluminum_alloy_upgrade_smithing_template",
                                                        REGISTRATE.addLang("item", NeoECOAE.id(
                                                                        "smithing_template.aluminum_alloy_upgrade.applies_to"),
                                                                        "Aluminum Equipment")
                                                                        .withStyle(ChatFormatting.BLUE),
                                                        REGISTRATE.addLang("item", NeoECOAE.id(
                                                                        "smithing_template.aluminum_alloy_upgrade.ingredients"),
                                                                        "Aluminum Alloy Ingot")
                                                                        .withStyle(ChatFormatting.BLUE),
                                                        REGISTRATE.addLang("upgrade",
                                                                        NeoECOAE.id("aluminum_alloy_upgrade"),
                                                                        "Aluminum Alloy Upgrade")
                                                                        .withStyle(ChatFormatting.GRAY),
                                                        REGISTRATE.addLang("item",
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                                                ...
                                                .unlockedBy("has_aliminim_alloy_ingot",
                                                                RegistrateRecipeProvider
                                                                                .has(NETags.Items.ALUMINUM_ALLOY_INGOT))
                                                .save(prov);
                        })
                        .register();
        ...
        public static final ItemEntry<AxeItem> ALUMINUM_ALLOY_AXE = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                ...
                                                .unlocks("has_item",
                                                                RegistrateRecipeProvider
                                                                                .has(NEItems.ALUMINUM_ALLOY_INGOT))
        ...
        public static final ItemEntry<SmithingTemplateItem> BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE = REGISTRATE
                        .<SmithingTemplateItem>item("black_tungsten_alloy_upgrade_smithing_template",
                                        p -> new NamedSmithingTemplateItem(
                                                        "item.neoecoae.black_tungsten_alloy_upgrade_smithing_template",
                                                        REGISTRATE.addLang("item", NeoECOAE.id(
                                                                        "smithing_template.black_tungsten_alloy_upgrade.applies_to"),
                                                                        "Tungsten Equipment")
                                                                        .withStyle(ChatFormatting.BLUE),
                                                        REGISTRATE
                                                                        .addLang("item", NeoECOAE.id(
                                                                                        "smithing_template.black_tungsten_alloy_upgrade.ingredients"),
                                                        ...
                                                        REGISTRATE.addLang("item",
                                                                        NeoECOAE.id("smithing_template.black_tungsten_alloy_upgrade.additions_slot_description"),
        ...
        public static final ItemEntry<AxeItem> BLACK_TUNGSTEN_ALLOY_AXE = REGISTRATE
                        .item("black_tungsten_alloy_axe",
                                        p -> new AxeItem(NEToolTier.BLACK_TUNGSTEN_ALLOY, 6.0F, -3.2F, p))
                        .tag(ItemTags.AXES)
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                ...
                                                .unlocks("has_item",
                                                                RegistrateRecipeProvider.has(
                                                                                NEItems.BLACK_TUNGSTEN_ALLOY_INGOT))
                                                .save(prov, ctx.getId().withSuffix("_smithing"));
                        })
                        .register();

        public static final ItemEntry<HoeItem> BLACK_TUNGSTEN_ALLOY_HOE = REGISTRATE
                        .item("black_tungsten_alloy_hoe",
                                        p -> new HoeItem(NEToolTier.BLACK_TUNGSTEN_ALLOY, 0, -3.0F, p))
                        .tag(ItemTags.HOES)
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                Ingredient.of(NEItems.BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE),
        ...
        public static final ItemEntry<ShovelItem> BLACK_TUNGSTEN_ALLOY_SHOVEL = REGISTRATE
                        .item("black_tungsten_alloy_shovel",
                                        p -> new ShovelItem(NEToolTier.BLACK_TUNGSTEN_ALLOY, 1.5F, -3.0F, p))
                        .tag(ItemTags.SHOVELS)
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                Ingredient.of(NEItems.BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE),
        ...
        public static final ItemEntry<PickaxeItem> BLACK_TUNGSTEN_ALLOY_PICKAXE = REGISTRATE
                        .item("black_tungsten_alloy_pickaxe",
                                        p -> new PickaxeItem(NEToolTier.BLACK_TUNGSTEN_ALLOY, 1, -2.8F, p))
                        .tag(ItemTags.PICKAXES)
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                Ingredient.of(NEItems.BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE),
        ...
        public static final ItemEntry<SwordItem> BLACK_TUNGSTEN_ALLOY_SWORD = REGISTRATE
                        .item("black_tungsten_alloy_sword",
                                        p -> new SwordItem(NEToolTier.BLACK_TUNGSTEN_ALLOY, 3, -2.4F, p))
                        .tag(ItemTags.SWORDS)
                        .recipe((ctx, prov) -> {
                                SmithingTransformRecipeBuilder.smithing(
                                                Ingredient.of(NEItems.BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE),
        ...
        public static final ItemEntry<MaterialItem> RAW_ALUMINUM_ORE = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                                                ...
                                                .unlockedBy("has_raw_aluminum_block",
                                                                RegistrateRecipeProvider.has(
        ...
        public static final ItemEntry<MaterialItem> ALUMINUM_INGOT = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                prov.smelting(DataIngredient.tag(NETags.Items.ALUMINUM_ORE), RecipeCategory.MISC, ctx,
                                                0.8f);
        ...
        public static final ItemEntry<MaterialItem> RAW_TUNGSTEN_ORE = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                                                ...
                                                .unlockedBy("has_raw_tungsten_block",
                                                                RegistrateRecipeProvider.has(
        ...
        public static final ItemEntry<MaterialItem> TUNGSTEN_INGOT = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                prov.smelting(DataIngredient.tag(NETags.Items.TUNGSTEN_ORE), RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.smelting(DataIngredient.tag(NETags.Items.TUNGSTEN_RAW), RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.smelting(DataIngredient.tag(NETags.Items.TUNGSTEN_DUST), RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.blasting(DataIngredient.tag(NETags.Items.TUNGSTEN_ORE), RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.blasting(DataIngredient.tag(NETags.Items.TUNGSTEN_RAW), RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.blasting(DataIngredient.tag(NETags.Items.TUNGSTEN_DUST), RecipeCategory.MISC, ctx,
                                                1.0f);
        ...
        public static final ItemEntry<MaterialItem> ALUMINUM_ALLOY_INGOT = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                                                ...
                                                .unlockedBy("has_aluminum_alloy_block",
                                                                RegistrateRecipeProvider.has(
                                                                                NETags.Items.ALUMINUM_ALLOY_STORAGE_BLOCK))
                                                .save(prov);

                                prov.smelting(DataIngredient.tag(NETags.Items.ALUMINUM_ALLOY_DUST), RecipeCategory.MISC,
                                                ctx, 1.0f);
                                prov.blasting(DataIngredient.tag(NETags.Items.ALUMINUM_ALLOY_DUST), RecipeCategory.MISC,
                                                ctx, 1.0f);
                        })
                        .register();
        ...
        public static final ItemEntry<MaterialItem> BLACK_TUNGSTEN_ALLOY_INGOT = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                                                ...
                                                .unlockedBy("has_black_tungsten_alloy_block",
                                                                RegistrateRecipeProvider.has(
                                                                                NETags.Items.BLACK_TUNGSTEN_ALLOY_STORAGE_BLOCK))
                                                .save(prov);

                                prov.smelting(DataIngredient.tag(NETags.Items.BLACK_TUNGSTEN_ALLOY_DUST),
                                                RecipeCategory.MISC, ctx,
                                                1.0f);
                                prov.blasting(DataIngredient.tag(NETags.Items.BLACK_TUNGSTEN_ALLOY_DUST),
                                                RecipeCategory.MISC, ctx,
                                                1.0f);
                        })
                        .register();
        ...
        public static final ItemEntry<MaterialItem> BLACK_TUNGSTEN_ALLOY_DUST = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                                                ...
                                                .unlockedBy("has_aluminum_dust",
                                                                RegistrateRecipeProvider
                                                                                .has(NETags.Items.ALUMINUM_ALLOY_DUST))
                                                .unlockedBy("has_tungsten_dust",
                                                                RegistrateRecipeProvider
                                                                                .has(NETags.Items.TUNGSTEN_DUST))
                                                .unlockedBy("has_certus_quartz_dust",
                                                                RegistrateRecipeProvider
                                                                                .has(ConventionTags.CERTUS_QUARTZ_DUST))
                                                .save(prov);
        ...
        public static final ItemEntry<MaterialItem> ENERGIZED_CRYSTAL = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 4)
                                                ...
                                                .unlockedBy("has_energized_crystal_block",
                                                                RegistrateRecipeProvider.has(
        ...
        public static final ItemEntry<MaterialItem> ENERGIZED_FLUIX_CRYSTAL = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 4)
                                                ...
                                                .unlockedBy("has_energized_fluix_crytal_block",
                                                                RegistrateRecipeProvider.has(
                                                                                NETags.Items.ENERGIZED_FLUIX_CRYSTAL_BLOCK))
        ...
        public static final ItemEntry<MaterialItem> CRYSTAL_MATRIX = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ctx.get(), 1)
                                                ...
                                                .unlockedBy("has_crystal_ingot",
                                                                RegistrateRecipeProvider.has(NEItems.CRYSTAL_INGOT))
                                                .save(prov);
                        })
                        .register();
        ...
        public static final ItemEntry<MaterialItem> ENERGIZED_SUPERCONDUCTIVE_INGOT = REGISTRATE
                        ...
                        .recipe((ctx, prov) -> {
                                ...
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                                                ...
                                                .unlockedBy("has_block", RegistrateRecipeProvider
                                                                .has(NEBlocks.ENERGIZED_SUPERCONDUCTIVE_BLOCK))
                                                .save(prov);
                        })
                        .register();
                        ...
                        .recipe((ctx, prov) -> {
                                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                                                ...
                                                .unlockedBy("has_energized_cryztal_dust",
                                                                RegistrateRecipeProvider.has(
                                                                                NETags.Items.ENERGIZED_CRYSTAL_DUST))
                                                .save(prov);
                        })
                        .register();
                        ...
                        .recipe((ctx, prov) -> {
                                ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ctx.get())
                                                ...
                                                .unlockedBy("has_energized_superconductive_ingot",
                                                                RegistrateRecipeProvider.has(
                                                                                NEItems.ENERGIZED_SUPERCONDUCTIVE_INGOT))
                                                .save(prov);
