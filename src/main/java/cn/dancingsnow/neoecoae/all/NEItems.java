...
public class NEItems {
    ...
    public static final ItemEntry<SmithingTemplateItem> ALUMINUM_ALLOY_UPGRADE_SMITHING_TEMPLATE = REGISTRATE
            .item("aluminum_alloy_upgrade_smithing_template", p -> new SmithingTemplateItem(
                    ...
                    REGISTRATE.addLang("item", NeoECOAE.id("smithing_template.aluminum_alloy_upgrade.ingredients"),
                            "Aluminum Alloy Ingot").withStyle(ChatFormatting.BLUE),
                    REGISTRATE.addLang("upgrade", NeoECOAE.id("aluminum_alloy_upgrade"), "Aluminum Alloy Upgrade")
    ...
    public static final ItemEntry<SmithingTemplateItem> BLACK_TUNGSTEN_ALLOY_UPGRADE_SMITHING_TEMPLATE = REGISTRATE
            .item("black_tungsten_alloy_upgrade_smithing_template", p -> new SmithingTemplateItem(
                    ...
                    REGISTRATE
                            .addLang("item", NeoECOAE.id("smithing_template.black_tungsten_alloy_upgrade.ingredients"),
                                    "Black Tungsten Alloy Ingot")
                            .withStyle(ChatFormatting.BLUE),
                    REGISTRATE.addLang("upgrade", NeoECOAE.id("black_tungsten_alloy_upgrade"),
                            "Black Tungsten Alloy Upgrade").withStyle(ChatFormatting.GRAY),
                    REGISTRATE.addLang("item",
            ...
            .recipe((ctx, prov) -> {
                ...
                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                        ...
                        .unlockedBy("has_aluminum_block",
                                RegistrateRecipeProvider.has(NETags.Items.ALUMINUM_STORAGE_BLOCK))
                        .save(prov);
            })
            .register();
            ...
            .recipe((ctx, prov) -> {
                ...
                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                        ...
                        .unlockedBy("has_tungsten_block",
                                RegistrateRecipeProvider.has(NETags.Items.TUNGSTEN_STORAGE_BLOCK))
                        .save(prov);
            })
    ...
    public static final ItemEntry<MaterialItem> BLACK_TUNGSTEN_ALLOY_INGOT = REGISTRATE
            ...
            .recipe((ctx, prov) -> {
                ...
                prov.smelting(DataIngredient.tag(NETags.Items.BLACK_TUNGSTEN_ALLOY_DUST), RecipeCategory.MISC, ctx,
                        1.0f);
                prov.blasting(DataIngredient.tag(NETags.Items.BLACK_TUNGSTEN_ALLOY_DUST), RecipeCategory.MISC, ctx,
                        1.0f);
            })
            .register();
