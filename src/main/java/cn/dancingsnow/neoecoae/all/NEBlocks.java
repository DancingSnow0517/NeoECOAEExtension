...
public class NEBlocks {
    ...
    public static final BlockEntry<ECOCraftingNetworkSwitch> CRAFTING_HIGH_ENERGY_NETWORK_SWITCH = REGISTRATE
            ...
            .loot((tables, block) -> tables.dropSelf(block))
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    .require(CRAFTING_NETWORK_SWITCH, 16)
                    .require(NEBlocks.CRAFTING_PARALLEL_CORE_L9, 8)
                    .require(NEBlocks.CRAFTING_WORKER, 16)
                    .require(NEBlocks.CRAFTING_SYSTEM_L9, 4)
                    .require(AEItems.SINGULARITY, 8)
                    .require(NEBlocks.BLACK_TUNGSTEN_ALLOY_BLOCK, 8)
                    .require(NEItems.ECO_CELL_COMPONENT_256M, 1)
                    .require(AEItems.CELL_COMPONENT_256K, 16)
    ...
    public static final BlockEntry<ECOComputationNetworkSwitch> COMPUTATION_HIGH_ENERGY_NETWORK_SWITCH = REGISTRATE
            ...
            .loot((tables, block) -> tables.dropSelf(block))
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    .require(COMPUTATION_NETWORK_SWITCH, 16)
                    .require(NEBlocks.ENERGY_CELL_L9, 4)
                    .require(NEBlocks.COMPUTATION_THREADING_CORE_L9, 4)
                    .require(NEBlocks.COMPUTATION_PARALLEL_CORE_L9, 4)
                    .require(NEBlocks.COMPUTATION_COOLING_CONTROLLER_L9, 4)
