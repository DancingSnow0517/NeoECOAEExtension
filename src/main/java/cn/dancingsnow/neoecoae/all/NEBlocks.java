...
public class NEBlocks {
    ...
    public static final BlockEntry<CertusQuartzClusterBlock> SMALL_ENERGIZED_CRYSTAL_BUD = REGISTRATE
        ...
        .blockstate(() -> ECOModelUtil.quartzCluster())
    ...
    public static final BlockEntry<ECOIntegratedWorkingStation> INTEGRATED_WORKING_STATION = REGISTRATE
        ...
        .blockstate(() -> ECOModelUtil.integratedWorkingStation())
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("ABC")
                .pattern("DEF")
    ...
    public static final BlockEntry<ECOMachineInterface<NEStorageCluster>> STORAGE_INTERFACE = REGISTRATE
        ...
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .simpleItem()
        .blockstate(() -> ECOModelUtil.simpleExisting())
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("ABA")
                .pattern("CDC")
    ...
    public static final BlockEntry<ECOEnergyCellBlock> ENERGY_CELL_L4 = REGISTRATE
        ...
        .initialProperties(() -> Blocks.IRON_BLOCK)
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .blockstate(() -> ECOModelUtil.storageEnergyCell("l4"))
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("AAA")
                .pattern("ABA")
    ...
    public static final BlockEntry<ECOEnergyCellBlock> ENERGY_CELL_L6 = REGISTRATE
        ...
        .initialProperties(() -> Blocks.IRON_BLOCK)
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .blockstate(() -> ECOModelUtil.storageEnergyCell("l6"))
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("AAA")
                .pattern("ABA")
    ...
    public static final BlockEntry<ECOEnergyCellBlock> ENERGY_CELL_L9 = REGISTRATE
        ...
        .initialProperties(() -> Blocks.IRON_BLOCK)
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .blockstate(() -> ECOModelUtil.storageEnergyCell("l9"))
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("AAA")
                .pattern("ABA")
    ...
    public static final BlockEntry<ECOComputationTransmitter> COMPUTATION_TRANSMITTER = REGISTRATE
        ...
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .simpleItem()
        .blockstate(() -> ECOModelUtil.computationTransmitter())
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("ABA")
                .pattern("CDC")
    ...
    public static final BlockEntry<ECOCraftingWorker> CRAFTING_WORKER = REGISTRATE
        ...
        .build()
        .lang("ECO - FX Worker")
        .blockstate(() -> ECOModelUtil.craftingWorker())
        .register();
    ...
    public static final BlockEntry<ECOCraftingPatternBus> CRAFTING_PATTERN_BUS = REGISTRATE
        ...
        .blockstate(() -> ECOModelUtil.craftingPatternBus())
        .item()
        .properties(p -> p.rarity(Rarity.RARE))
        .build()
    ...
    public static final BlockEntry<ECOCraftingVent> CRAFTING_VENT = REGISTRATE
        ...
        .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
        .simpleItem()
        .blockstate(() -> ECOModelUtil.craftingVent())
        .recipe((ctx, prov) -> {
            ShapedRecipeBuilder.shaped(prov.itemLookup(), RecipeCategory.MISC, ctx.get())
                .pattern("ABA")
                .pattern("BCB")
    ...
    public static final BlockEntry<ECOMachineCasing<NECraftingCluster>> CRAFTING_CASING = REGISTRATE
        ...
        .blockstate(() -> ECOModelUtil.craftingCasing())
        .simpleItem()
        .register();
    //endregion
    ...
    private static BlockEntry<ECOStorageSystemBlock> createStorageSystem(String level, Rarity rarity) {
        return REGISTRATE
            ...
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.storageSystem(level))
            .item()
    ...
    private static BlockEntry<ECOCraftingParallelCore> createParallelCore(String level, IECOTier tier, Rarity rarity) {
        return REGISTRATE
            ...
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.craftingParallelCore(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
            .lang("ECO - %s Parallel Core".formatted(level.toUpperCase(Locale.ROOT)).replace("L", "FT"))
            .register();
    }
    ...
    private static BlockEntry<ECOCraftingSystem> createCraftingSystem(String level, Rarity rarity) {
        return REGISTRATE
            ...
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.craftingSystem(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
            .lang("ECO - %s Extensible Crafting Controller".formatted(level.toUpperCase(Locale.ROOT)).replace("L", "F"))
            .register();
    }
    ...
    private static BlockEntry<ECOComputationSystem> createComputationSystem(String level, Rarity rarity) {
        return REGISTRATE
            ...
            .properties(BlockBehaviour.Properties::noOcclusion)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.computationSystem(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
            .lang("ECO - %s Extensible Computation Subsystem Controller".formatted(level.toUpperCase(Locale.ROOT)).replace("L", "C"))
            .register();
    }
    ...
    private static BlockEntry<ECOComputationParallelCore> createComputationParallelCore(String level, IECOTier tier, Rarity rarity) {
        return REGISTRATE
            ...
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.computationParallelCore(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
    ...
    private static BlockEntry<ECOComputationThreadingCore> createComputationThreadingCore(String level, IECOTier tier, Rarity rarity) {
        return REGISTRATE
            ...
            .initialProperties(() -> Blocks.IRON_BLOCK)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.computationThreadingCore(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
            .lang("ECO - %sA Threading Core".formatted(level.toUpperCase(Locale.ROOT)).replace("L", "CM"))
            .register();
    }
    ...
    private static BlockEntry<ECOComputationCoolingController> createComputationCoolingController(String level, Rarity rarity) {
        return REGISTRATE
            ...
            .properties(BlockBehaviour.Properties::noOcclusion)
            .tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_STONE_TOOL)
            .blockstate(() -> ECOModelUtil.computationCoolingController(level))
            .item()
            .properties(p -> p.rarity(rarity))
            .build()
