...
public class NEBlocks {
    public static final BlockEntry<ECOCraftingNetworkSwitch> CRAFTING_NETWORK_SWITCH = REGISTRATE
            ...
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    ...
                    .require(NEBlocks.CRAFTING_PARALLEL_CORE_L9, 8)
                    ...
                    .forAllStatesExcept(
                            state -> ConfiguredModel.builder()
                                    .modelFile(provider.models()
                                            .getExistingFile(provider.modLoc("block/" + ctx.getName())))
                                    .build(),
                            NENetworkSwitchBlock.FORMED))
            .simpleItem()
    ...
    public static final BlockEntry<ECOComputationNetworkSwitch> COMPUTATION_NETWORK_SWITCH = REGISTRATE
            ...
            .loot((tables, block) -> tables.dropSelf(block))
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    .require(NEBlocks.ENERGY_CELL_L9, 4)
                    .require(NEBlocks.COMPUTATION_THREADING_CORE_L9, 4)
                    .require(NEBlocks.COMPUTATION_PARALLEL_CORE_L9, 4)
                    .require(NEBlocks.COMPUTATION_COOLING_CONTROLLER_L9, 4)
                    .require(NEBlocks.COMPUTATION_SYSTEM_L9, 4)
                    .require(AEItems.CELL_COMPONENT_256K, 16)
                    .require(AEBlocks.CRAFTING_STORAGE_256K, 1)
                    .require(AEItems.SINGULARITY, 8)
                    .require(NEItems.CRYSTAL_MATRIX, 16)
                    .energy(4_000_000)
                    .itemOutput(ctx.get())
                    .save(provider, ctx.getId().withPrefix("integrated_working_station/")))
            .blockstate((ctx, provider) -> provider.getVariantBuilder(ctx.get())
    ...
    public static final BlockEntry<ECOCraftingNetworkSwitch> CRAFTING_HIGH_ENERGY_NETWORK_SWITCH = REGISTRATE
            ...
            .loot((tables, block) -> tables.dropSelf(block))
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    .require(CRAFTING_NETWORK_SWITCH, 32)
                    .require(NEBlocks.CRAFTING_PARALLEL_CORE_L9, 32)
                    .require(NEBlocks.CRAFTING_WORKER, 64)
                    .require(NEBlocks.CRAFTING_SYSTEM_L9, 16)
    ...
    public static final BlockEntry<ECOComputationNetworkSwitch> COMPUTATION_HIGH_ENERGY_NETWORK_SWITCH = REGISTRATE
            ...
            .loot((tables, block) -> tables.dropSelf(block))
            .recipe((ctx, provider) -> IntegratedWorkingStationRecipe.builder()
                    .require(COMPUTATION_NETWORK_SWITCH, 32)
                    .require(NEBlocks.ENERGY_CELL_L9, 16)
                    .require(NEBlocks.COMPUTATION_THREADING_CORE_L9, 16)
                    .require(NEBlocks.COMPUTATION_PARALLEL_CORE_L9, 16)
                    .require(NEBlocks.COMPUTATION_COOLING_CONTROLLER_L9, 16)
                    .require(NEBlocks.COMPUTATION_SYSTEM_L9, 16)
                    .require(AEItems.SINGULARITY, 32)
                    .require(NEBlocks.BLACK_TUNGSTEN_ALLOY_BLOCK, 32)
                    .require(AEItems.CELL_COMPONENT_256K, 64)
                    .requireFluid(NEFluids.CRYOTHEUM_SOLUTION.getSource(), 16_000)
    ...
    public static final BlockEntry<CasingBlock> ALUMINUM_ALLOY_CASING = REGISTRATE
            ...
            .blockstate((ctx, prov) -> {
                BlockModelBuilder model = prov.models()
                        .withExistingParent(ctx.getName(), prov.modLoc("block/casing_base"))
    ...
    private static BlockEntry<ECOCraftingSystem> createCraftingSystem(String level, Rarity rarity) {
        return REGISTRATE
                ...
                .blockstate((ctx, prov) -> {
                    ...
                    ModelFile networkSwitchFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(prov.modLoc(
                                            "block/crafting_controller/controller_l9_network_switch_formed"))
                            : formedModel;
                    ModelFile networkSwitchMirroredFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(prov.modLoc(
                                            "block/crafting_controller/controller_l9_network_switch_formed_mirrored"))
                            : formedMirroredModel;
                    ModelFile highEnergyNetworkSwitchFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(prov.modLoc(
                                            "block/crafting_controller/controller_l9_power_network_switch_formed"))
                            : formedModel;
                    ModelFile highEnergyNetworkSwitchMirroredFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(
                                            prov.modLoc(
                                                    "block/crafting_controller/controller_l9_power_network_switch_formed_mirrored"))
                            : formedMirroredModel;
                    prov.getVariantBuilder(ctx.get()).forAllStates(s -> {
                        boolean formed = s.getValue(NEBlock.FORMED);
                        boolean mirrored = s.getValue(NEBlock.MIRRORED);
                                        ...
                                        !formed
                                                ...
                                                : mirrored
                                                        ? (s.getValue(ECOCraftingSystem.HIGH_ENERGY_NETWORK_SWITCH)
                                                                ...
                                                                : s.getValue(ECOCraftingSystem.NETWORK_SWITCH)
                                                                        ? networkSwitchMirroredFormedModel
                                                                        : formedMirroredModel)
                                                        : (s.getValue(ECOCraftingSystem.HIGH_ENERGY_NETWORK_SWITCH)
                                                                ? highEnergyNetworkSwitchFormedModel
                                                                : s.getValue(ECOCraftingSystem.NETWORK_SWITCH)
                                                                        ? networkSwitchFormedModel
                                                                        : formedModel))
                                .rotationY(((int) s.getValue(BlockStateProperties.HORIZONTAL_FACING)
                                                        .toYRot()
                                                + 180)
        ...
        return REGISTRATE
                ...
                .blockstate((ctx, prov) -> {
                    ...
                    ModelFile networkSwitchFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(prov.modLoc(
                                            "block/computation_controller/controller_l9_network_switch_formed"))
                            : formedModel;
                    ModelFile networkSwitchMirroredFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(
                                            prov.modLoc(
                                                    "block/computation_controller/controller_l9_network_switch_formed_mirrored"))
                            : formedMirroredModel;
                    ModelFile highEnergyNetworkSwitchFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(prov.modLoc(
                                            "block/computation_controller/controller_l9_power_network_switch_formed"))
                            : formedModel;
                    ModelFile highEnergyNetworkSwitchMirroredFormedModel = "l9".equals(level)
                            ? prov.models()
                                    .getExistingFile(
                                            prov.modLoc(
                                                    "block/computation_controller/controller_l9_power_network_switch_formed_mirrored"))
                            : formedMirroredModel;
                    prov.getVariantBuilder(ctx.get()).forAllStates(s -> {
                        boolean formed = s.getValue(NEBlock.FORMED);
                        boolean mirrored = s.getValue(NEBlock.MIRRORED);
                                        ...
                                        !formed
                                                ...
                                                : mirrored
                                                        ? (s.getValue(ECOComputationSystem.HIGH_ENERGY_NETWORK_SWITCH)
                                                                ? highEnergyNetworkSwitchMirroredFormedModel
                                                                : s.getValue(ECOComputationSystem.NETWORK_SWITCH)
                                                                        ? networkSwitchMirroredFormedModel
                                                                        : formedMirroredModel)
                                                        : (s.getValue(ECOComputationSystem.HIGH_ENERGY_NETWORK_SWITCH)
                                                                ? highEnergyNetworkSwitchFormedModel
