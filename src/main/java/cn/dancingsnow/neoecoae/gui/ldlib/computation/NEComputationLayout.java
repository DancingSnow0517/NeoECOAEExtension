...
public final class NEComputationLayout {
    ...
    public static final int PARALLEL_PANEL_W = 80;
    ...
    public static final int PARALLEL_PANEL_H = 34;
    public static final int PARALLEL_TITLE_X = PARALLEL_PANEL_X + 6;
    public static final int PARALLEL_TITLE_Y = PARALLEL_PANEL_Y + 7;
    /** Matches AE2's VerticalButtonBar: 2px gap from the UI edge and a 16px icon button. */
    public static final int PARALLEL_TOGGLE_X = PARALLEL_PANEL_X + PARALLEL_PANEL_W - 16;

    public static final int PARALLEL_TOGGLE_Y = PARALLEL_PANEL_Y + 2;
    ...
    public static final int PARALLEL_STEP_BUTTON_Y = PARALLEL_PANEL_Y + 18;
    public static final int PARALLEL_STEP_BUTTON_W = 16;
    public static final int PARALLEL_STEP_BUTTON_H = 16;
    public static final int PARALLEL_DECREASE_X = PARALLEL_PANEL_X + 2;
    public static final int PARALLEL_FIELD_X = PARALLEL_PANEL_X + 20;
    public static final int PARALLEL_FIELD_W = 42;
    public static final int PARALLEL_FIELD_H = 16;
    public static final int PARALLEL_INCREASE_X = PARALLEL_PANEL_X + 62;
    public static final int PARALLEL_FIELD_Y = PARALLEL_STEP_BUTTON_Y;
