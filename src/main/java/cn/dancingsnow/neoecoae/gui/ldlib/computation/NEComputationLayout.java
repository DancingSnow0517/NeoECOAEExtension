...
public final class NEComputationLayout {
    ...
    public static final int UI_HEIGHT = 242;
    ...
    /** Host controls follow the order of the 1.21.1 side rail. */
    public static final int FAST_TASK_PLANNING_BUTTON_X = -17;

    public static final int FAST_TASK_PLANNING_BUTTON_Y = 91;
    public static final int FAST_TASK_PLANNING_BUTTON_W = 16;
    public static final int FAST_TASK_PLANNING_BUTTON_H = 16;
    ...
    public static final int CPU_BUTTON_W = 16;
    public static final int CPU_BUTTON_H = 16;
    public static final int CPU_BUTTON_X = -17;
    public static final int CPU_BUTTON_Y = 25;
    public static final int NETWORK_FREQUENCY_BUTTON_W = 16;
    public static final int NETWORK_FREQUENCY_BUTTON_H = 16;
    public static final int NETWORK_FREQUENCY_BUTTON_X = -17;
    public static final int NETWORK_FREQUENCY_BUTTON_Y = 113;
    public static final int HEADER_STATUS_RIGHT = BASE_UI_WIDTH - 8;
