...
final class StorageHostElements {
    ...
    static Label sectionLabel(Supplier<Component> text, IntSupplier color) {
    ...
    static UIElement horizontalRow(int height, int gap) {
    ...
    static <T extends UIElement> T absolute(T element, int left, int top, int width, int height) {
