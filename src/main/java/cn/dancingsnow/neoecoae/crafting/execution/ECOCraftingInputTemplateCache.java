...
final class ECOCraftingInputTemplateCache {
    ...
    private final Map<IPatternDetails.IInput, List<InputTemplate>> entries = new Reference2ObjectOpenHashMap<>();
    private final Set<AEKey> knownKeys = new ObjectOpenHashSet<>();
