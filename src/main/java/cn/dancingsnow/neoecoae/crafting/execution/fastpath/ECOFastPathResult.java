...
public final class ECOFastPathResult {
    ...
    public static ECOFastPathResult positive(
        ...
        return positive(
                ...
                tick,
                null,
                Set.of(FastPathCapability.PURE_LINEAR),
    ...
    public static ECOFastPathResult positive(
        ...
        return positive(
                ...
                tick,
                reusableStateModel,
                reusableStateModel == null
                        ? Set.of(FastPathCapability.PURE_LINEAR)
                        : Set.of(reusableStateModel.capability()),
                ECORecipeClassifier.Type.NORMAL,
                List.of(),
                List.of(),
                List.of(),
    ...
    @Nullable public ECOReusableStateModel reusableStateModel() {
        return reusableStateModel;
    }

    @Nullable public ECODurabilityBatchModel durabilityModel() {
        return reusableStateModel instanceof ECODurabilityBatchModel durability ? durability : null;
    }

    public Set<FastPathCapability> capabilities() {
        return capabilities;
    }

    public boolean hasCapability(FastPathCapability capability) {
    ...
    public static List<ECOFastPathComponentChange> componentChanges(List<ItemStack> before, List<ItemStack> after) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (left == null
                    ...
                    || ItemStack.isSameItemSameTags(left, right)) continue;
