...
public final class ECOFastPathLookup {
    ...
    private static final ECOFastPathLookup MISMATCH =
            new ECOFastPathLookup(Status.MISMATCH, null, "CACHE_RESULT_MISMATCH");

    private final Status status;
    private final String reason;

    @Nullable private final ECOVerifiedFastPathRecipe recipe;
    ...
    @Nullable public ECOVerifiedFastPathRecipe recipe() {
        return recipe;
    }
}
