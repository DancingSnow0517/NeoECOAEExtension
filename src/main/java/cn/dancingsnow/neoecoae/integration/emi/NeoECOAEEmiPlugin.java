...
public class NeoECOAEEmiPlugin implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        for (RecipeHolder<IntegratedWorkingStationRecipe> holder :
                registry.getRecipeManager().getAllRecipesFor(NERecipeTypes.INTEGRATED_WORKING_STATION.get())) {
        ...
        for (RecipeHolder<CoolingRecipe> holder :
                registry.getRecipeManager().getAllRecipesFor(NERecipeTypes.COOLING.get())) {
