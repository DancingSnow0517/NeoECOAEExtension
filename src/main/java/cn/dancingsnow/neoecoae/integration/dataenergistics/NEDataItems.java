    ...
    public static final ItemEntry<MaterialItem> ECO_DATA_CELL_HOUSING = REGISTRATE
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ctx.get())
                ...
                .unlockedBy("has_black_tungsten_alloy", RegistrateRecipeProvider.has(NETags.Items.BLACK_TUNGSTEN_ALLOY_INGOT))
    ...
    public static final ItemEntry<ECODataStorageCellItem> ECO_DATA_CELL_16M = REGISTRATE
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                .requires(NEDataItems.ECO_DATA_CELL_HOUSING)
                ...
                .save(dataenergisticsInstalled);
            StorageCellDisassemblyRecipe recipe = new StorageCellDisassemblyRecipe(ctx.get(), List.of(NEDataItems.ECO_DATA_CELL_HOUSING.asStack(), NEItems.ECO_CELL_COMPONENT_16M.asStack()));
    ...
    public static final ItemEntry<ECODataStorageCellItem> ECO_DATA_CELL_64M = REGISTRATE
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                ...
                .save(dataenergisticsInstalled);
            StorageCellDisassemblyRecipe recipe = new StorageCellDisassemblyRecipe(ctx.get(), List.of(NEDataItems.ECO_DATA_CELL_HOUSING.asStack(), NEItems.ECO_CELL_COMPONENT_64M.asStack()));
            dataenergisticsInstalled.accept(ctx.getId().withPrefix("disassembly/"), recipe, null);
        })
    ...
    public static final ItemEntry<ECODataStorageCellItem> ECO_DATA_CELL_256M = REGISTRATE
        ...
        .recipe((ctx, prov) -> {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get())
                ...
                .save(dataenergisticsInstalled);
            StorageCellDisassemblyRecipe recipe = new StorageCellDisassemblyRecipe(ctx.get(), List.of(NEDataItems.ECO_DATA_CELL_HOUSING.asStack(), NEItems.ECO_CELL_COMPONENT_256M.asStack()));
            dataenergisticsInstalled.accept(ctx.getId().withPrefix("disassembly/"), recipe, null);
        })
