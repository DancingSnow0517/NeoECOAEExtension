...
//            .addIngredients(NeoForgeTypes.FLUID_STACK, Arrays.asList(recipe.input().ingredient().fluids()))
//            .setFluidRenderer(1,false, 16,16);
//        builder.addOutputSlot(72, 11)
//            .add(recipe.output().getFluid(), recipe.output().getAmount())
//            .setFluidRenderer(1,false, 16,16);
//    }
//
//    @Override
