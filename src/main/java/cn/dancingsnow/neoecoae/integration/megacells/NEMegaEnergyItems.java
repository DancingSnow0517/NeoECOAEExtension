...
final class NEMegaEnergyItems {
    static final ItemEntry<Item> MEGA_ENERGY_CELL_HOUSING = NEMegaItems.housing("mega_energy", "Mega Energy");
    static final ItemEntry<ECOMegaEnergyStorageCellItem> CELL_4G =
            cell("4g", ECOTier.L9, MEGA_4G_CAPACITY, Rarity.EPIC);

    private static ItemEntry<ECOMegaEnergyStorageCellItem> cell(
        ...
        return NEMegaItems.optionalCell(
                ...
                capacity,
                rarity,
                ECOMegaEnergyStorageCellItem::new,
                NEMegaEnergyCellType.MEGA_ENERGY);
    }
