...
final class NEMegaChemicalItems {
    static final ItemEntry<Item> MEGA_CHEMICAL_CELL_HOUSING = NEMegaItems.housing("mega_chemical", "Mega Chemical");
    static final ItemEntry<ECOMegaChemicalStorageCellItem> CELL_4G =
            cell("4g", ECOTier.L9, MEGA_4G_CAPACITY, Rarity.EPIC);

    private static ItemEntry<ECOMegaChemicalStorageCellItem> cell(
            String size, ECOTier tier, long capacity, Rarity rarity) {
        return NEMegaItems.optionalCell(
                "mega_chemical",
                "Mega Chemical",
                size,
                tier,
                capacity,
                rarity,
                ECOMegaChemicalStorageCellItem::new,
                NEMegaChemicalCellType.MEGA_CHEMICAL);
    }
