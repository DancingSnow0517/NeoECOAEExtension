...
final class NEMegaChemicalItems {
    static final ItemEntry<MaterialItem> MEGA_CHEMICAL_CELL_HOUSING =
    ...
    static final ItemEntry<ECOMegaChemicalStorageCellItem> CELL_4G = cell("4g", ECOTier.L9, COMPRESSED_4G_CAPACITY, Rarity.EPIC);
