...
class SpecialPatternResolverTest {
    ...
    void returnedCatalystIsSharedAcrossPatternsButNotAcrossSimultaneousSlots() throws Exception {
        ...
        var input = new cn.dancingsnow.neoecoae.crafting.planner.compile.CompiledInput(
        ...
        var resolver = new SpecialPatternResolver(null, state, java.util.Map.of(),
            cn.dancingsnow.neoecoae.crafting.planner.ECOCancellation.NONE, false);
        ...
        org.mockito.Mockito.when(pattern.specialAnalysis()).thenReturn(
            new cn.dancingsnow.neoecoae.crafting.planner.semantic.SpecialPatternAnalysis(java.util.List.of(requirement, requirement)));
