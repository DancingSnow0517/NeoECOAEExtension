...
class ECOBatchCraftingHelperTest {
    ...
    void fullEnergyFastPathUsesOneSimulation() {
        ...
        int result = ECOBatchCraftingHelper.maxAffordableCrafts(3.0D, 256, requested -> {
    ...
    void rejectsInvalidBatchRequestBoundariesBeforeDispatch() {
        ...
        ECOFastPathKey key =
                ECOFastPathKey.of("request", new KeyCounter[0], null, 0L).orElseThrow();
        ...
        assertThrows(
                ...
                () -> new ECOBatchCraftingRequest(
                        details,
                        key,
                        ECOBatchCraftingHelper.MAX_BATCH_SIZE + 1,
                        List.of(),
                        List.of(),
                        List.of(),
                        null));
